...
If data are pre-normalized and/or pre-imputed, it can be indicated with the corresponding parameters `data.type` and any information about the method used that you woould like to store in the object can be added using the corresponding parameters `normalization.method` and `imputation.method`.<br></br>
