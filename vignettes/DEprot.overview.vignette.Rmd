...
Ultimately, if the metadata table does not contain a `column.id` column corresponding to the column names of the `counts_table`, it is possible to indicate the name of another column that should be assumed to be the `column.id`.
