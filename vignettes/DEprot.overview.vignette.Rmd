...
The protein ranking is define based on the differential scored, computed as: `abs(log2(fold change)) * -log10(Padj)`.

The resulting object is of class `DEprot.counts.heatmap`, and contains the ggplot-hetamap, the row cluster and the column cluster.
